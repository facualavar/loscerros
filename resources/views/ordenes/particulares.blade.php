          ...
          success:function(resp){
              if(resp.status==1){
                ...
                data1=' <div class="table-responsive">'+
                        ...
                        '<tbody>'+
                        '<tr>'+
                            '<th style="with:10%">Fecha - N° de Informe</th>'+
                            '<th style="with:20%">Paciente</th>'+
                            '<th style="with:40%">Análisis</th>'+
                            '<th style="with:10%">Precio Part</th>';
                    ...
                    var url = '{{route("ordenespdf",["fecha1"=>"'fecha1'","fecha2"=>"'fecha2'","obra"=>68])}}';
